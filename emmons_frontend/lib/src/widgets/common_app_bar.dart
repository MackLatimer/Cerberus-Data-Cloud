...
class CommonAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  Size get preferredSize => Size.fromHeight(kToolbarHeight * 16); // Target 16x AppBar height
}
    ...
    return AppBar(
      ...
      leading: Padding(
        ...
        child: SizedBox( // Added SizedBox to explicitly control logo size
          height: (kToolbarHeight * 16) * 0.9, // Logo height 90% of 16x AppBar height
          width: (kToolbarHeight * 16) * 0.9 * 3.125, // Proportional width
