...
The following additional packages will be installed:
  eslint gyp handlebars libauthen-sasl-perl libc-ares2 libclone-perl
  libdata-dump-perl libegl-mesa0 libegl1 libencode-locale-perl
  libfile-basedir-perl libfile-desktopentry-perl libfile-listing-perl
  libfile-mimeinfo-perl libfont-afm-perl libgbm1 libgles2 libhtml-form-perl
  ...
  libnode108 libnotify-bin libnotify4 libregexp-ipv6-perl libssl-dev
  libtext-iconv-perl libtie-ixhash-perl libtimedate-perl libtry-tiny-perl
  liburi-perl libuv1 libuv1-dev libwayland-client0 libwayland-server0
  libwww-perl libwww-robotrules-perl libx11-protocol-perl libxml-parser-perl
  libxml-twig-perl libxml-xpathengine-perl node-abbrev node-acorn
  ...
  perl-openssl-defaults python3-six terser webpack x11-xserver-utils xdg-utils
  zutty
Suggested packages:
  node-babel-eslint node-esprima-fb node-inquirer libdigest-hmac-perl
  libgssapi-perl libjs-angularjs libcrypt-ssleay-perl notification-daemon
  libssl-doc libsub-name-perl libbusiness-isbn-perl libauthen-ntlm-perl
  libunicode-map8-perl libunicode-string-perl xml-twig-tools
  node-babel-plugin-polyfill-es-shims node-babel7-debug livescript chai
  node-jest-diff debhelper zip nickle cairo-5c xorg-docs-core
The following NEW packages will be installed:
  ...
  perl-openssl-defaults python3-six terser unzip webpack x11-xserver-utils
  xdg-utils zutty
0 upgraded, 450 newly installed, 0 to remove and 0 not upgraded.
Need to get 33.2 MB of archives.
After this operation, 190 MB of additional disk space will be used.
Get:1 http://deb.debian.org/debian bookworm/main amd64 node-fast-deep-equal all 3.1.3-3 [5768 B]
Get:2 http://deb.debian.org/debian bookworm/main amd64 node-json-schema-traverse all 1.0.0-3 [6308 B]
Get:3 http://deb.debian.org/debian bookworm/main amd64 node-jsonify all 0.0.1-1 [8704 B]
Get:4 http://deb.debian.org/debian bookworm/main amd64 node-json-stable-stringify all 1.0.2+~cs5.2.34-1 [11.3 kB]
Get:5 http://deb.debian.org/debian bookworm/main amd64 libc-ares2 amd64 1.18.1-3 [102 kB]
Get:6 http://deb.debian.org/debian bookworm/main amd64 libuv1 amd64 1.44.2-1+deb12u1 [136 kB]
Get:7 http://deb.debian.org/debian bookworm/main amd64 node-xtend all 4.0.2-3 [3932 B]
Get:8 http://deb.debian.org/debian bookworm/main amd64 node-acorn all 8.8.1+ds+~cs25.17.7-2 [128 kB]
Get:9 http://deb.debian.org/debian bookworm/main amd64 node-cjs-module-lexer all 1.2.2+dfsg-5 [30.1 kB]
Get:10 http://deb.debian.org/debian bookworm/main amd64 node-busboy all 1.6.0+~cs2.6.0-2 [16.9 kB]
Get:11 http://deb.debian.org/debian bookworm/main amd64 node-undici all 5.15.0+dfsg1+~cs20.10.9.3-1+deb12u4 [285 kB]
Get:12 http://deb.debian.org/debian bookworm/main amd64 libnode108 amd64 18.19.0+dfsg-6~deb12u2 [10.5 MB]
Get:13 http://deb.debian.org/debian bookworm/main amd64 nodejs amd64 18.19.0+dfsg-6~deb12u2 [319 kB]
Get:14 http://deb.debian.org/debian bookworm/main amd64 node-punycode all 2.1.1-6 [9444 B]
Get:15 http://deb.debian.org/debian bookworm/main amd64 node-uri-js all 4.4.0+dfsg-8 [47.3 kB]
Get:16 http://deb.debian.org/debian bookworm/main amd64 node-ajv all 6.12.6-3 [74.0 kB]
Get:17 http://deb.debian.org/debian bookworm/main amd64 libjs-inherits all 2.0.4-6 [3548 B]
Get:18 http://deb.debian.org/debian bookworm/main amd64 node-inherits all 2.0.4-6 [4548 B]
Get:19 http://deb.debian.org/debian bookworm/main amd64 node-core-util-is all 1.0.3-1 [4072 B]
Get:20 http://deb.debian.org/debian bookworm/main amd64 node-safe-buffer all 5.2.1+~cs2.1.2-3 [15.5 kB]
Get:21 http://deb.debian.org/debian bookworm/main amd64 node-string-decoder all 1.3.0-6 [7180 B]
Get:22 http://deb.debian.org/debian bookworm/main amd64 node-process-nextick-args all 2.0.1-3 [3816 B]
Get:23 http://deb.debian.org/debian bookworm/main amd64 node-util-deprecate all 1.0.2-3 [4436 B]
Get:24 http://deb.debian.org/debian bookworm/main amd64 node-isarray all 2.0.5-4 [4040 B]
Get:25 http://deb.debian.org/debian bookworm/main amd64 node-readable-stream all 3.6.0+~cs3.0.0-4 [32.0 kB]
Get:26 http://deb.debian.org/debian bookworm/main amd64 node-typedarray all 0.0.7-1 [11.4 kB]
Get:27 http://deb.debian.org/debian bookworm/main amd64 node-concat-stream all 2.0.0+~2.0.0-2 [6388 B]
Get:28 http://deb.debian.org/debian bookworm/main amd64 node-ms all 2.1.3+~cs0.7.31-3 [5648 B]
Get:29 http://deb.debian.org/debian bookworm/main amd64 node-debug all 4.3.4+~cs4.1.7-1 [18.1 kB]
Get:30 http://deb.debian.org/debian bookworm/main amd64 node-esutils all 2.0.3+~2.0.0-1 [12.4 kB]
Get:31 http://deb.debian.org/debian bookworm/main amd64 node-doctrine all 3.0.0-4 [19.9 kB]
Get:32 http://deb.debian.org/debian bookworm/main amd64 node-eslint-visitor-keys all 3.3.0+~1.0.0-1 [17.1 kB]
Get:33 http://deb.debian.org/debian bookworm/main amd64 node-estraverse all 5.3.0+ds+~5.1.1-1 [11.6 kB]
Get:34 http://deb.debian.org/debian bookworm/main amd64 node-object-assign all 4.1.1-7 [4684 B]
Get:35 http://deb.debian.org/debian bookworm/main amd64 node-esrecurse all 4.3.0-2 [6048 B]
Get:36 http://deb.debian.org/debian bookworm/main amd64 node-eslint-scope all 7.1.1+~3.7.4-1 [35.6 kB]
Get:37 http://deb.debian.org/debian bookworm/main amd64 node-espree all 9.4.1~dfsg-1 [41.0 kB]
Get:38 http://deb.debian.org/debian bookworm/main amd64 node-esquery all 1.4.2~ds-1 [24.9 kB]
Get:39 http://deb.debian.org/debian bookworm/main amd64 node-eslint-utils all 3.0.0-3 [15.5 kB]
Get:40 http://deb.debian.org/debian bookworm/main amd64 node-flatted all 3.2.7~ds-1 [10.3 kB]
Get:41 http://deb.debian.org/debian bookworm/main amd64 node-fs.realpath all 1.0.0-3 [6172 B]
Get:42 http://deb.debian.org/debian bookworm/main amd64 node-wrappy all 1.0.2-3 [3776 B]
Get:43 http://deb.debian.org/debian bookworm/main amd64 node-once all 1.4.0-7 [4492 B]
Get:44 http://deb.debian.org/debian bookworm/main amd64 node-inflight all 1.0.6-2 [3952 B]
Get:45 http://deb.debian.org/debian bookworm/main amd64 node-balanced-match all 2.0.0-1 [4872 B]
Get:46 http://deb.debian.org/debian bookworm/main amd64 node-brace-expansion all 2.0.1-2 [7320 B]
Get:47 http://deb.debian.org/debian bookworm/main amd64 node-minimatch all 5.1.1+~5.1.2-1 [18.6 kB]
Get:48 http://deb.debian.org/debian bookworm/main amd64 node-glob all 8.0.3+~cs8.4.15-1 [133 kB]
Get:49 http://deb.debian.org/debian bookworm/main amd64 node-rimraf all 3.0.2-2 [11.1 kB]
Get:50 http://deb.debian.org/debian bookworm/main amd64 node-write all 2.0.0~6.0.0+~3.0.4+~2.0.0+~1.0.0+~2.0.1-5 [17.8 kB]
Get:51 http://deb.debian.org/debian bookworm/main amd64 node-flat-cache all 3.0.4~6.0.0+~3.0.4+~2.0.0+~1.0.0+~2.0.1-5 [20.1 kB]
Get:52 http://deb.debian.org/debian bookworm/main amd64 node-file-entry-cache all 6.0.0+~3.0.4+~2.0.0+~1.0.0+~2.0.1-5 [15.0 kB]
Get:53 http://deb.debian.org/debian bookworm/main amd64 node-functional-red-black-tree all 1.0.1+20181105-7 [14.1 kB]
Get:54 http://deb.debian.org/debian bookworm/main amd64 node-is-extglob all 2.1.1-5 [4612 B]
Get:55 http://deb.debian.org/debian bookworm/main amd64 node-is-glob all 4.0.3-2 [6620 B]
Get:56 http://deb.debian.org/debian bookworm/main amd64 node-path-dirname all 1.0.2-2 [4312 B]
Get:57 http://deb.debian.org/debian bookworm/main amd64 node-glob-parent all 6.0.2+~5.1.1-2 [8784 B]
Get:58 http://deb.debian.org/debian bookworm/main amd64 node-globals all 13.18.0-1 [11.1 kB]
Get:59 http://deb.debian.org/debian bookworm/main amd64 node-resolve-from all 5.0.0+~3.1.0+~3.3.0+~2.0.0-1 [7292 B]
Get:60 http://deb.debian.org/debian bookworm/main amd64 node-imurmurhash all 0.1.4+dfsg+~0.1.1-2 [8412 B]
Get:61 http://deb.debian.org/debian bookworm/main amd64 node-ignore all 5.2.1-1 [26.4 kB]
Get:62 http://deb.debian.org/debian bookworm/main amd64 node-prelude-ls all 1.2.1+dfsg-3 [11.3 kB]
Get:63 http://deb.debian.org/debian bookworm/main amd64 node-type-check all 0.4.0+dfsg-3 [9184 B]
Get:64 http://deb.debian.org/debian bookworm/main amd64 node-levn all 0.4.1+dfsg-2 [10.2 kB]
Get:65 http://deb.debian.org/debian bookworm/main amd64 node-lodash all 4.17.21+dfsg+~cs8.31.198.20210220-9 [462 kB]
Get:66 http://deb.debian.org/debian bookworm/main amd64 node-memfs all 3.4.12+~cs1.0.3-1 [46.8 kB]
Get:67 http://deb.debian.org/debian bookworm/main amd64 node-mkdirp all 1.0.4+~1.0.2-4 [11.6 kB]
Get:68 http://deb.debian.org/debian bookworm/main amd64 node-deep-is all 0.1.4-1 [5136 B]
Get:69 http://deb.debian.org/debian bookworm/main amd64 node-fast-levenshtein all 2.0.6+ds-3 [6040 B]
Get:70 http://deb.debian.org/debian bookworm/main amd64 node-optionator all 0.9.1+dfsg+~cs1.2.3-1 [17.6 kB]
Get:71 http://deb.debian.org/debian bookworm/main amd64 node-progress all 2.0.3-2 [8256 B]
Get:72 http://deb.debian.org/debian bookworm/main amd64 libjs-regenerate all 1.4.2-3 [14.3 kB]
Get:73 http://deb.debian.org/debian bookworm/main amd64 node-regenerate all 1.4.2-3 [7388 B]
Get:74 http://deb.debian.org/debian bookworm/main amd64 node-regenerate-unicode-properties all 10.1.0+ds-1 [50.7 kB]
Get:75 http://deb.debian.org/debian bookworm/main amd64 node-regexpp all 3.2.0-4 [27.0 kB]
Get:76 http://deb.debian.org/debian bookworm/main amd64 node-yallist all 4.0.0+~4.0.1-1 [8172 B]
Get:77 http://deb.debian.org/debian bookworm/main amd64 node-lru-cache all 7.14.1-1 [26.3 kB]
Get:78 http://deb.debian.org/debian bookworm/main amd64 node-semver all 7.3.5+~7.3.9-2 [42.1 kB]
Get:79 http://deb.debian.org/debian bookworm/main amd64 node-strip-json-comments all 4.0.0-4 [5668 B]
Get:80 http://deb.debian.org/debian bookworm/main amd64 node-json-schema all 0.4.0+~7.0.11-1 [13.1 kB]
Get:81 http://deb.debian.org/debian bookworm/main amd64 node-v8-compile-cache all 2.3.0-3+deb12u1 [8464 B]
Get:82 http://deb.debian.org/debian bookworm/main amd64 eslint all 6.4.0~dfsg+~6.1.9-7 [606 kB]
Get:83 http://deb.debian.org/debian bookworm/main amd64 python3-six all 1.16.0-4 [17.5 kB]
Get:84 http://deb.debian.org/debian bookworm/main amd64 gyp all 0.1+20220404git9ecf45e-2 [237 kB]
Get:85 http://deb.debian.org/debian bookworm/main amd64 node-neo-async all 2.6.2+~cs3.0.0-2 [35.2 kB]
Get:86 http://deb.debian.org/debian bookworm/main amd64 node-arrify all 2.0.1-3 [3700 B]
Get:87 http://deb.debian.org/debian bookworm/main amd64 node-is-plain-obj all 3.0.0-2 [3972 B]
Get:88 http://deb.debian.org/debian bookworm/main amd64 node-is-buffer all 2.0.5-2 [4112 B]
Get:89 http://deb.debian.org/debian bookworm/main amd64 node-kind-of all 6.0.3+dfsg-2 [10.2 kB]
Get:90 http://deb.debian.org/debian bookworm/main amd64 node-minimist all 1.2.7+~cs5.3.2-2 [14.7 kB]
Get:91 http://deb.debian.org/debian bookworm/main amd64 node-wordwrap all 1.0.0-4 [4628 B]
Get:92 http://deb.debian.org/debian bookworm/main amd64 node-optimist all 0.6.1+~0.0.30-2 [13.5 kB]
Get:93 http://deb.debian.org/debian bookworm/main amd64 libjs-source-map all 0.7.0++dfsg2+really.0.6.1-15 [29.6 kB]
Get:94 http://deb.debian.org/debian bookworm/main amd64 node-source-map all 0.7.0++dfsg2+really.0.6.1-15 [41.7 kB]
Get:95 http://deb.debian.org/debian bookworm/main amd64 handlebars all 3:4.7.7+~4.1.0-1 [199 kB]
Get:96 http://deb.debian.org/debian bookworm/main amd64 libauthen-sasl-perl all 2.1600-3 [43.9 kB]
Get:97 http://deb.debian.org/debian bookworm/main amd64 libclone-perl amd64 0.46-1 [13.7 kB]
Get:98 http://deb.debian.org/debian bookworm/main amd64 libdata-dump-perl all 1.25-1 [28.4 kB]
Get:99 http://deb.debian.org/debian bookworm/main amd64 libwayland-server0 amd64 1.21.0-1 [35.9 kB]
Get:100 http://deb.debian.org/debian bookworm/main amd64 libgbm1 amd64 22.3.6-1+deb12u1 [38.0 kB]
Get:101 http://deb.debian.org/debian bookworm/main amd64 libwayland-client0 amd64 1.21.0-1 [28.3 kB]
Get:102 http://deb.debian.org/debian bookworm/main amd64 libegl-mesa0 amd64 22.3.6-1+deb12u1 [114 kB]
Get:103 http://deb.debian.org/debian bookworm/main amd64 libencode-locale-perl all 1.05-3 [12.9 kB]
Get:104 http://deb.debian.org/debian bookworm/main amd64 libipc-system-simple-perl all 1.30-2 [26.8 kB]
Get:105 http://deb.debian.org/debian bookworm/main amd64 libfile-basedir-perl all 0.09-2 [15.1 kB]
Get:106 http://deb.debian.org/debian bookworm/main amd64 libregexp-ipv6-perl all 0.03-3 [5212 B]
Get:107 http://deb.debian.org/debian bookworm/main amd64 liburi-perl all 5.17-1 [90.4 kB]
Get:108 http://deb.debian.org/debian bookworm/main amd64 libfile-desktopentry-perl all 0.22-3 [17.6 kB]
Get:109 http://deb.debian.org/debian bookworm/main amd64 libtimedate-perl all 2.3300-2 [39.3 kB]
Get:110 http://deb.debian.org/debian bookworm/main amd64 libhttp-date-perl all 6.05-2 [10.5 kB]
Get:111 http://deb.debian.org/debian bookworm/main amd64 libfile-listing-perl all 6.15-1 [12.6 kB]
Get:112 http://deb.debian.org/debian bookworm/main amd64 libfile-mimeinfo-perl all 0.33-1 [48.3 kB]
Get:113 http://deb.debian.org/debian bookworm/main amd64 libfont-afm-perl all 1.20-4 [13.1 kB]
Get:114 http://deb.debian.org/debian bookworm/main amd64 libgles2 amd64 1.6.0-1 [16.8 kB]
Get:115 http://deb.debian.org/debian bookworm/main amd64 libhtml-tagset-perl all 3.20-6 [11.7 kB]
...
Get:129 http://deb.debian.org/debian bookworm/main amd64 libio-stringy-perl all 2.111-3 [56.5 kB]
Get:130 http://deb.debian.org/debian bookworm/main amd64 libjs-async all 0.8.0-6 [24.2 kB]
Get:131 http://deb.debian.org/debian bookworm/main amd64 libjs-events all 3.3.0+~3.0.0-3 [11.3 kB]
Get:132 http://deb.debian.org/debian bookworm/main amd64 libjs-is-typedarray all 1.0.0-4 [3816 B]
Get:133 http://deb.debian.org/debian bookworm/main amd64 libjs-prettify all 2015.12.04+dfsg-1.1 [41.7 kB]
Get:134 http://deb.debian.org/debian bookworm/main amd64 libjs-sprintf-js all 1.1.2+ds1+~1.1.2-1 [12.8 kB]
Get:135 http://deb.debian.org/debian bookworm/main amd64 libjs-typedarray-to-buffer all 4.0.0-2 [4668 B]
Get:136 http://deb.debian.org/debian bookworm/main amd64 node-lodash-packages all 4.17.21+dfsg+~cs8.31.198.20210220-9 [179 kB]
Get:137 http://deb.debian.org/debian bookworm/main amd64 node-function-bind all 1.1.1+repacked+~1.0.3-2 [5252 B]
Get:138 http://deb.debian.org/debian bookworm/main amd64 node-object-inspect all 1.12.2+~cs1.8.1-1 [20.8 kB]
Get:139 http://deb.debian.org/debian bookworm/main amd64 node-es-abstract all 1.20.4+~cs26.27.47-1 [137 kB]
Get:140 http://deb.debian.org/debian bookworm/main amd64 node-resolve all 1.22.1+~cs5.31.10-1 [28.1 kB]
Get:141 http://deb.debian.org/debian bookworm/main amd64 node-define-properties all 1.1.4+~1.1.3-1 [6828 B]
Get:142 http://deb.debian.org/debian bookworm/main amd64 node-debbundle-es-to-primitive all 1.2.1+~cs9.7.25-2 [39.9 kB]
Get:143 http://deb.debian.org/debian bookworm/main amd64 node-defined all 1.0.1+~1.0.0-1 [6776 B]
Get:144 http://deb.debian.org/debian bookworm/main amd64 node-abbrev all 1.1.1+~1.1.2-1 [5692 B]
Get:145 http://deb.debian.org/debian bookworm/main amd64 node-archy all 1.0.0-6 [4556 B]
Get:146 http://deb.debian.org/debian bookworm/main amd64 node-async all 0.8.0-6 [3748 B]
Get:147 http://deb.debian.org/debian bookworm/main amd64 node-convert-source-map all 1.9.0+~1.5.2-1 [8176 B]
Get:148 http://deb.debian.org/debian bookworm/main amd64 node-decamelize all 4.0.0-2 [4080 B]
Get:149 http://deb.debian.org/debian bookworm/main amd64 node-es6-error all 4.1.1-5 [6148 B]
Get:150 http://deb.debian.org/debian bookworm/main amd64 node-esprima all 4.0.1+ds+~4.0.3-2 [69.3 kB]
Get:151 http://deb.debian.org/debian bookworm/main amd64 node-escodegen all 2.0.0+dfsg+~0.0.7-2 [23.0 kB]
Get:152 http://deb.debian.org/debian bookworm/main amd64 node-commondir all 1.0.1+~1.0.0-1 [4388 B]
Get:153 http://deb.debian.org/debian bookworm/main amd64 node-is-number all 7.0.0-4 [6020 B]
Get:154 http://deb.debian.org/debian bookworm/main amd64 node-repeat-string all 1.6.1+repack-1 [5600 B]
Get:155 http://deb.debian.org/debian bookworm/main amd64 node-to-regex-range all 5.0.1-4 [10.5 kB]
Get:156 http://deb.debian.org/debian bookworm/main amd64 node-fill-range all 7.0.1+~7.0.0-1 [8952 B]
Get:157 http://deb.debian.org/debian bookworm/main amd64 node-braces all 3.0.2+~3.0.1-1 [20.8 kB]
Get:158 http://deb.debian.org/debian bookworm/main amd64 node-normalize-path all 3.0.0+~3.0.0-1 [6608 B]
Get:159 http://deb.debian.org/debian bookworm/main amd64 node-anymatch all 3.1.3+~cs4.6.1-2 [33.4 kB]
Get:160 http://deb.debian.org/debian bookworm/main amd64 node-micromatch all 4.0.5+~4.0.2-1 [25.8 kB]
Get:161 http://deb.debian.org/debian bookworm/main amd64 node-pify all 5.0.0+~cs5.0.1-1 [7072 B]
Get:162 http://deb.debian.org/debian bookworm/main amd64 node-path-type all 4.0.0-3 [3944 B]
Get:163 http://deb.debian.org/debian bookworm/main amd64 node-n3 all 1.16.3+~1.2.3+~1.10.4-1 [37.0 kB]
Get:164 http://deb.debian.org/debian bookworm/main amd64 node-slash all 4.0.0-3 [4292 B]
Get:165 http://deb.debian.org/debian bookworm/main amd64 node-globby all 13.1.3+~cs16.25.40-1+deb12u1 [40.5 kB]
Get:166 http://deb.debian.org/debian bookworm/main amd64 node-graceful-fs all 4.2.10-1 [14.4 kB]
Get:167 http://deb.debian.org/debian bookworm/main amd64 node-is-path-cwd all 2.2.0-2 [3672 B]
Get:168 http://deb.debian.org/debian bookworm/main amd64 node-path-is-inside all 1.0.2+~1.0.0-1 [5072 B]
Get:169 http://deb.debian.org/debian bookworm/main amd64 node-is-path-inside all 3.0.3-2 [3980 B]
Get:170 http://deb.debian.org/debian bookworm/main amd64 node-escape-string-regexp all 4.0.0-2 [4296 B]
Get:171 http://deb.debian.org/debian bookworm/main amd64 node-indent-string all 4.0.0-2 [4144 B]
Get:172 http://deb.debian.org/debian bookworm/main amd64 node-p-map all 4.0.0+~3.1.0+~3.0.1-1 [7912 B]
Get:173 http://deb.debian.org/debian bookworm/main amd64 node-del all 7.0.0-5 [6804 B]
Get:174 http://deb.debian.org/debian bookworm/main amd64 node-make-dir all 3.1.0-3 [6040 B]
Get:175 http://deb.debian.org/debian bookworm/main amd64 node-p-limit all 4.0.0+~cs4.0.0-5 [7576 B]
Get:176 http://deb.debian.org/debian bookworm/main amd64 node-p-locate all 6.0.0-12 [5752 B]
Get:177 http://deb.debian.org/debian bookworm/main amd64 node-locate-path all 7.1.1-2 [5584 B]
Get:178 http://deb.debian.org/debian bookworm/main amd64 node-path-exists all 5.0.0-8 [4732 B]
Get:179 http://deb.debian.org/debian bookworm/main amd64 node-find-up all 6.3.0-7 [9388 B]
Get:180 http://deb.debian.org/debian bookworm/main amd64 node-pkg-dir all 5.0.0-2 [4260 B]
Get:181 http://deb.debian.org/debian bookworm/main amd64 node-find-cache-dir all 3.3.2+~3.2.1-1 [6152 B]
Get:182 http://deb.debian.org/debian bookworm/main amd64 node-signal-exit all 3.0.7+~3.0.1-1 [7600 B]
Get:183 http://deb.debian.org/debian bookworm/main amd64 node-foreground-child all 2.0.0-5 [6384 B]
Get:184 http://deb.debian.org/debian bookworm/main amd64 node-is-stream all 3.0.0-4 [5076 B]
Get:185 http://deb.debian.org/debian bookworm/main amd64 node-is-windows all 1.0.2+~cs1.0.0-1 [5936 B]
Get:186 http://deb.debian.org/debian bookworm/main amd64 node-sprintf-js all 1.1.2+ds1+~1.1.2-1 [4024 B]
Get:187 http://deb.debian.org/debian bookworm/main amd64 node-argparse all 2.0.1-2 [34.6 kB]
Get:188 http://deb.debian.org/debian bookworm/main amd64 node-js-yaml all 4.1.0+dfsg+~4.0.5-7 [66.6 kB]
Get:189 http://deb.debian.org/debian bookworm/main amd64 node-nopt all 5.0.0-4 [12.1 kB]
Get:190 http://deb.debian.org/debian bookworm/main amd64 node-npm-run-path all 5.1.0+~4.0.0-8 [6276 B]
Get:191 http://deb.debian.org/debian bookworm/main amd64 node-shebang-regex all 3.0.0-2 [3528 B]
Get:192 http://deb.debian.org/debian bookworm/main amd64 node-shebang-command all 2.0.0-1 [3500 B]
Get:193 http://deb.debian.org/debian bookworm/main amd64 node-strip-bom all 4.0.0-2 [4144 B]
Get:194 http://deb.debian.org/debian bookworm/main amd64 node-has-flag all 4.0.0-3 [4304 B]
Get:195 http://deb.debian.org/debian bookworm/main amd64 node-supports-color all 8.1.1+~8.1.1-1 [6920 B]
Get:196 http://deb.debian.org/debian bookworm/main amd64 node-util all 0.12.5+~1.0.10-1 [5700 B]
Get:197 http://deb.debian.org/debian bookworm/main amd64 node-assert all 2.0.0+~cs3.9.8-2 [26.8 kB]
Get:198 http://deb.debian.org/debian bookworm/main amd64 node-ampproject-remapping all 2.2.0+~cs5.15.37-1 [59.4 kB]
Get:199 http://deb.debian.org/debian bookworm/main amd64 node-babel-plugin-add-module-exports all 1.0.4+dfsg1~cs5.8.0-4 [8672 B]
Get:200 http://deb.debian.org/debian bookworm/main amd64 node-regenerator-runtime all 0.15.1+~0.10.8-1 [10.6 kB]
Get:201 http://deb.debian.org/debian bookworm/main amd64 node-babel7-runtime all 7.20.15+ds1+~cs214.269.168-3+deb12u2 [116 kB]
Get:202 http://deb.debian.org/debian bookworm/main amd64 node-babel-helper-define-polyfill-provider all 0.3.3~0~20220913+ds1-1 [27.4 kB]
Get:203 http://deb.debian.org/debian bookworm/main amd64 node-babel-plugin-polyfill-corejs2 all 0.3.3~0~20220913+ds1-1 [17.1 kB]
Get:204 http://deb.debian.org/debian bookworm/main amd64 node-caniuse-lite all 1.0.30001436+dfsg+~1.0.1-1 [208 kB]
Get:205 http://deb.debian.org/debian bookworm/main amd64 node-electron-to-chromium all 1.4.284-1 [20.6 kB]
Get:206 http://deb.debian.org/debian bookworm/main amd64 node-picocolors all 1.0.0-4 [6652 B]
Get:207 http://deb.debian.org/debian bookworm/main amd64 node-browserslist all 4.21.4+~cs6.1.17-2 [63.5 kB]
Get:208 http://deb.debian.org/debian bookworm/main amd64 node-core-js-compat all 3.26.1-3 [66.1 kB]
Get:209 http://deb.debian.org/debian bookworm/main amd64 node-babel-plugin-polyfill-corejs3 all 0.6.0~0~20220913+ds1-1 [29.5 kB]
Get:210 http://deb.debian.org/debian bookworm/main amd64 node-babel-plugin-polyfill-regenerator all 0.4.1~0~20220913+ds1-1 [5036 B]
Get:211 http://deb.debian.org/debian bookworm/main amd64 node-color-name all 1.1.4+~1.1.1-2 [5920 B]
Get:212 http://deb.debian.org/debian bookworm/main amd64 node-color-convert all 2.0.1+~cs2.0.0-2 [13.1 kB]
Get:213 http://deb.debian.org/debian bookworm/main amd64 node-ansi-styles all 6.2.1-2 [8640 B]
Get:214 http://deb.debian.org/debian bookworm/main amd64 node-chalk all 5.2.0-1 [18.0 kB]
Get:215 http://deb.debian.org/debian bookworm/main amd64 node-for-in all 1.0.2-4 [4840 B]
Get:216 http://deb.debian.org/debian bookworm/main amd64 node-for-own all 1.0.0-3 [4800 B]
Get:217 http://deb.debian.org/debian bookworm/main amd64 node-is-plain-object all 5.0.0-7 [6108 B]
Get:218 http://deb.debian.org/debian bookworm/main amd64 node-is-extendable all 1.0.1-3 [5228 B]
Get:219 http://deb.debian.org/debian bookworm/main amd64 node-clone-deep all 4.0.1+~cs7.0.2-1 [6720 B]
Get:220 http://deb.debian.org/debian bookworm/main amd64 node-commander all 9.4.1-1 [65.3 kB]
Get:221 http://deb.debian.org/debian bookworm/main amd64 node-core-js all 3.26.1-3 [268 kB]
Get:222 http://deb.debian.org/debian bookworm/main amd64 node-core-js-pure all 3.26.1-3 [250 kB]
Get:223 http://deb.debian.org/debian bookworm/main amd64 node-fs-readdir-recursive all 1.1.0+~1.1.0-1 [4540 B]
Get:224 http://deb.debian.org/debian bookworm/main amd64 node-js-tokens all 8.0.0-2 [14.9 kB]
Get:225 http://deb.debian.org/debian bookworm/main amd64 node-jsesc all 3.0.2+~3.0.1-1 [17.6 kB]
Get:226 http://deb.debian.org/debian bookworm/main amd64 node-json5 all 2.2.3+dfsg-1 [25.6 kB]
Get:227 http://deb.debian.org/debian bookworm/main amd64 node-quick-lru all 6.1.1-4 [8076 B]
Get:228 http://deb.debian.org/debian bookworm/main amd64 node-regenerator-transform all 0.15.1+~0.10.8-1 [24.6 kB]
Get:229 http://deb.debian.org/debian bookworm/main amd64 node-regjsgen all 0.7.1+ds-1 [6968 B]
Get:230 http://deb.debian.org/debian bookworm/main amd64 node-regjsparser all 0.9.1+ds-2 [22.1 kB]
Get:231 http://deb.debian.org/debian bookworm/main amd64 node-unicode-canonical-property-names-ecmascript all 2.0.0-2 [4540 B]
Get:232 http://deb.debian.org/debian bookworm/main amd64 node-unicode-property-aliases-ecmascript all 2.1.0+ds-1 [5256 B]
Get:233 http://deb.debian.org/debian bookworm/main amd64 node-unicode-match-property-ecmascript all 2.0.0-2 [4440 B]
Get:234 http://deb.debian.org/debian bookworm/main amd64 node-unicode-match-property-value-ecmascript all 2.1.0+ds-1 [7272 B]
Get:235 http://deb.debian.org/debian bookworm/main amd64 node-regexpu-core all 5.2.2-3 [13.9 kB]
Get:236 http://deb.debian.org/debian bookworm/main amd64 node-source-map-support all 0.5.21+ds+~0.5.4-1 [14.5 kB]
Get:237 http://deb.debian.org/debian bookworm/main amd64 node-to-fast-properties all 3.0.1-3 [4332 B]
Get:238 http://deb.debian.org/debian bookworm/main amd64 node-v8flags all 3.2.0+~3.1.1-1 [7612 B]
Get:239 http://deb.debian.org/debian bookworm/main amd64 node-babel7 all 7.20.15+ds1+~cs214.269.168-3+deb12u2 [712 kB]
Get:240 http://deb.debian.org/debian bookworm/main amd64 node-is-arrayish all 0.3.2-3 [3960 B]
Get:241 http://deb.debian.org/debian bookworm/main amd64 node-error-ex all 1.3.2-4 [5656 B]
Get:242 http://deb.debian.org/debian bookworm/main amd64 node-json-parse-better-errors all 1.0.2+~cs3.3.1-2 [7800 B]
Get:243 http://deb.debian.org/debian bookworm/main amd64 node-parse-json all 5.2.0+~cs5.1.7-1 [7356 B]
Get:244 http://deb.debian.org/debian bookworm/main amd64 node-hosted-git-info all 6.1.1-2 [12.6 kB]
Get:245 http://deb.debian.org/debian bookworm/main amd64 node-spdx-license-ids all 3.0.12-1 [6276 B]
Get:246 http://deb.debian.org/debian bookworm/main amd64 node-spdx-exceptions all 2.3.0-2 [3992 B]
Get:247 http://deb.debian.org/debian bookworm/main amd64 node-spdx-expression-parse all 3.0.1+~3.0.1-1 [7532 B]
Get:248 http://deb.debian.org/debian bookworm/main amd64 node-spdx-correct all 3.1.1-2 [5464 B]
Get:249 http://deb.debian.org/debian bookworm/main amd64 node-validate-npm-package-license all 3.0.4-2 [4280 B]
Get:250 http://deb.debian.org/debian bookworm/main amd64 node-normalize-package-data all 4.0.1+~2.4.1-1 [13.6 kB]
Get:251 http://deb.debian.org/debian bookworm/main amd64 node-read-pkg all 5.2.0-2 [24.0 kB]
Get:252 http://deb.debian.org/debian bookworm/main amd64 node-uuid all 8.3.2+~8.3.3-3 [44.0 kB]
Get:253 http://deb.debian.org/debian bookworm/main amd64 node-isexe all 2.0.0+~2.0.1-5 [6084 B]
Get:254 http://deb.debian.org/debian bookworm/main amd64 node-which all 2.0.2+~cs1.3.2-3 [8368 B]
Get:255 http://deb.debian.org/debian bookworm/main amd64 node-is-typedarray all 1.0.0-4 [3292 B]
Get:256 http://deb.debian.org/debian bookworm/main amd64 node-typedarray-to-buffer all 4.0.0-2 [3380 B]
Get:257 http://deb.debian.org/debian bookworm/main amd64 node-write-file-atomic all 4.0.2+~4.0.0-1 [9284 B]
Get:258 http://deb.debian.org/debian bookworm/main amd64 node-slice-ansi all 5.0.0+~cs9.0.0-5 [8788 B]
Get:259 http://deb.debian.org/debian bookworm/main amd64 node-ansi-regex all 5.0.1-1 [4912 B]
Get:260 http://deb.debian.org/debian bookworm/main amd64 node-strip-ansi all 6.0.1-2 [4120 B]
Get:261 http://deb.debian.org/debian bookworm/main amd64 node-clone all 2.1.2-4 [8280 B]
Get:262 http://deb.debian.org/debian bookworm/main amd64 node-defaults all 1.0.4+~1.0.3-1 [4400 B]
Get:263 http://deb.debian.org/debian bookworm/main amd64 node-wcwidth.js all 1.0.2-2 [7088 B]
Get:264 http://deb.debian.org/debian bookworm/main amd64 node-string-width all 4.2.3+~cs13.2.3-1 [10.7 kB]
Get:265 http://deb.debian.org/debian bookworm/main amd64 node-wrap-ansi all 8.0.1+~8.0.1-3 [11.8 kB]
Get:266 http://deb.debian.org/debian bookworm/main amd64 node-cliui all 7.0.4+repack+~cs3.1.0-4 [11.5 kB]
Get:267 http://deb.debian.org/debian bookworm/main amd64 node-get-caller-file all 2.0.5+~cs1.1.1-4 [5728 B]
Get:268 http://deb.debian.org/debian bookworm/main amd64 node-require-directory all 2.1.1+~2.1.2-1 [7092 B]
Get:269 http://deb.debian.org/debian bookworm/main amd64 node-y18n all 5.0.8+~5.0.0-3 [10.2 kB]
Get:270 http://deb.debian.org/debian bookworm/main amd64 node-camelcase all 7.0.0-3 [6032 B]
Get:271 http://deb.debian.org/debian bookworm/main amd64 node-yargs-parser all 21.1.1+~21.0.0-4 [28.4 kB]
Get:272 http://deb.debian.org/debian bookworm/main amd64 node-yargs all 16.2.0+~16.0.4-7 [128 kB]
Get:273 http://deb.debian.org/debian bookworm/main amd64 node-istanbul all 0.4.5+repack10+~cs97.25.57-3 [207 kB]
Get:274 http://deb.debian.org/debian bookworm/main amd64 node-through all 2.3.8+~cs0.0.30-1 [5452 B]
Get:275 http://deb.debian.org/debian bookworm/main amd64 node-resumer all 0.0.0-6 [4144 B]
Get:276 http://deb.debian.org/debian bookworm/main amd64 node-tape all 5.6.1+~cs8.20.19-1 [70.9 kB]
Get:277 http://deb.debian.org/debian bookworm/main amd64 node-deep-equal all 2.1.0+~cs31.12.80-1 [34.5 kB]
Get:278 http://deb.debian.org/debian bookworm/main amd64 libjs-util all 0.12.5+~1.0.10-1 [16.0 kB]
Get:279 http://deb.debian.org/debian bookworm/main amd64 libnet-http-perl all 6.22-1 [25.3 kB]
Get:280 http://deb.debian.org/debian bookworm/main amd64 libtry-tiny-perl all 0.31-2 [22.6 kB]
Get:281 http://deb.debian.org/debian bookworm/main amd64 libwww-robotrules-perl all 6.02-1 [12.9 kB]
Get:282 http://deb.debian.org/debian bookworm/main amd64 libwww-perl all 6.68-1 [186 kB]
Get:283 http://deb.debian.org/debian bookworm/main amd64 liblwp-protocol-https-perl all 6.10-1 [12.2 kB]
Get:284 http://deb.debian.org/debian bookworm/main amd64 libnet-smtp-ssl-perl all 1.04-2 [6548 B]
Get:285 http://deb.debian.org/debian bookworm/main amd64 libmailtools-perl all 2.21-2 [95.6 kB]
Get:286 http://deb.debian.org/debian bookworm/main amd64 libxml-parser-perl amd64 2.46-4 [201 kB]
Get:287 http://deb.debian.org/debian bookworm/main amd64 libxml-twig-perl all 1:3.52-2 [181 kB]
Get:288 http://deb.debian.org/debian bookworm/main amd64 libnet-dbus-perl amd64 1.2.0-2 [177 kB]
Get:289 http://deb.debian.org/debian bookworm-updates/main amd64 libssl-dev amd64 3.0.17-1~deb12u2 [2441 kB]
...
Get:297 http://deb.debian.org/debian bookworm/main amd64 libxml-xpathengine-perl all 0.14-2 [33.5 kB]
Get:298 http://deb.debian.org/debian bookworm/main amd64 node-agent-base all 6.0.2+~cs5.4.2-2 [17.3 kB]
Get:299 http://deb.debian.org/debian bookworm/main amd64 node-ajv-keywords all 3.5.2-2 [20.3 kB]
Get:300 http://deb.debian.org/debian bookworm/main amd64 node-ansi-escapes all 5.0.0+really.4.3.1-1 [8896 B]
Get:301 http://deb.debian.org/debian bookworm/main amd64 node-aproba all 2.0.0-3 [5844 B]
Get:302 http://deb.debian.org/debian bookworm/main amd64 node-delegates all 1.0.0-3 [4528 B]
Get:303 http://deb.debian.org/debian bookworm/main amd64 node-are-we-there-yet all 3.0.1+~1.1.0-1 [10.0 kB]
Get:304 http://deb.debian.org/debian bookworm/main amd64 node-async-each all 1.0.3-3 [4292 B]
Get:305 http://deb.debian.org/debian bookworm/main amd64 node-auto-bind all 4.0.0-2 [4816 B]
Get:306 http://deb.debian.org/debian bookworm/main amd64 node-babel-plugin-lodash all 3.3.4+~cs2.0.1-6 [11.0 kB]
Get:307 http://deb.debian.org/debian bookworm/main amd64 node-isobject all 4.0.0-2 [5332 B]
Get:308 http://deb.debian.org/debian bookworm/main amd64 node-object-visit all 1.0.1-5 [4868 B]
Get:309 http://deb.debian.org/debian bookworm/main amd64 node-map-visit all 1.0.0-4 [6208 B]
Get:310 http://deb.debian.org/debian bookworm/main amd64 node-collection-visit all 1.0.0-4 [4924 B]
Get:311 http://deb.debian.org/debian bookworm/main amd64 node-get-value all 1:3.0.1-4 [5248 B]
Get:312 http://deb.debian.org/debian bookworm/main amd64 node-sellside-emitter all 1.2.1-3 [4440 B]
Get:313 http://deb.debian.org/debian bookworm/main amd64 node-is-primitive all 3.0.1-3 [4892 B]
Get:314 http://deb.debian.org/debian bookworm/main amd64 node-set-value all 4.1.0+~4.0.1-2 [10.4 kB]
Get:315 http://deb.debian.org/debian bookworm/main amd64 node-union-value all 2.0.1-4 [5352 B]
Get:316 http://deb.debian.org/debian bookworm/main amd64 node-has-values all 2.0.1-4 [5628 B]
Get:317 http://deb.debian.org/debian bookworm/main amd64 node-has-value all 2.0.2-4 [6000 B]
Get:318 http://deb.debian.org/debian bookworm/main amd64 node-unset-value all 2.0.1-1 [5928 B]
Get:319 http://deb.debian.org/debian bookworm/main amd64 node-cache-base all 4.0.2-1 [12.4 kB]
Get:320 http://deb.debian.org/debian bookworm/main amd64 node-is-descriptor all 3.0.0-2 [5556 B]
Get:321 http://deb.debian.org/debian bookworm/main amd64 node-define-property all 2.0.2+really+2.0.2-3 [6820 B]
Get:322 http://deb.debian.org/debian bookworm/main amd64 node-mixin-deep all 2.0.1-3 [5428 B]
Get:323 http://deb.debian.org/debian bookworm/main amd64 node-pascalcase all 1.0.0-1 [5004 B]
Get:324 http://deb.debian.org/debian bookworm/main amd64 node-base all 3.0.0-3 [12.9 kB]
Get:325 http://deb.debian.org/debian bookworm/main amd64 node-base64-js all 1.5.1+dfsg+~1.3.0-2 [7140 B]
Get:326 http://deb.debian.org/debian bookworm/main amd64 node-binary-extensions all 2.2.0-2 [4408 B]
Get:327 http://deb.debian.org/debian bookworm/main amd64 node-builtins all 5.0.1-1 [4072 B]
Get:328 http://deb.debian.org/debian bookworm/main amd64 node-chownr all 2.0.0-2 [4424 B]
Get:329 http://deb.debian.org/debian bookworm/main amd64 node-iconv-lite all 0.6.3-3 [115 kB]
Get:330 http://deb.debian.org/debian bookworm/main amd64 node-encoding all 0.1.13-2 [4400 B]
Get:331 http://deb.debian.org/debian bookworm/main amd64 node-jsonparse all 1.3.1-10 [8020 B]
Get:332 http://deb.debian.org/debian bookworm/main amd64 node-minipass all 3.3.6+~cs9.4.19-1 [43.0 kB]
Get:333 http://deb.debian.org/debian bookworm/main amd64 node-iferr all 1.0.2+~1.0.2-1 [4588 B]
Get:334 http://deb.debian.org/debian bookworm/main amd64 node-fs-write-stream-atomic all 1.0.10-6 [5316 B]
Get:335 http://deb.debian.org/debian bookworm/main amd64 node-run-queue all 2.0.0-3 [5156 B]
Get:336 http://deb.debian.org/debian bookworm/main amd64 node-copy-concurrently all 1.0.5-9 [7100 B]
Get:337 http://deb.debian.org/debian bookworm/main amd64 node-move-concurrently all 1.0.1-5 [5152 B]
Get:338 http://deb.debian.org/debian bookworm/main amd64 node-promise-inflight all 1.0.1+~1.0.0-1 [4864 B]
Get:339 http://deb.debian.org/debian bookworm/main amd64 node-ssri all 9.0.1-2 [18.0 kB]
Get:340 http://deb.debian.org/debian bookworm/main amd64 node-unique-filename all 1.1.1+ds-2 [4032 B]
Get:341 http://deb.debian.org/debian bookworm/main amd64 node-cacache all 17.0.3+~cs10.3.7-1 [45.1 kB]
Get:342 http://deb.debian.org/debian bookworm/main amd64 node-is-binary-path all 2.1.0-5 [3684 B]
Get:343 http://deb.debian.org/debian bookworm/main amd64 node-path-is-absolute all 2.0.0-2 [4068 B]
Get:344 http://deb.debian.org/debian bookworm/main amd64 node-set-immediate-shim all 2.0.0-2 [3740 B]
Get:345 http://deb.debian.org/debian bookworm/main amd64 node-readdirp all 3.6.0-1 [11.5 kB]
Get:346 http://deb.debian.org/debian bookworm/main amd64 node-chokidar all 3.5.3-2 [32.3 kB]
Get:347 http://deb.debian.org/debian bookworm/main amd64 node-tslib all 2.4.1-1 [19.5 kB]
Get:348 http://deb.debian.org/debian bookworm/main amd64 node-chrome-trace-event all 1.0.3-2 [6984 B]
Get:349 http://deb.debian.org/debian bookworm/main amd64 node-ci-info all 3.6.1+~cs1.1.0-1 [11.7 kB]
Get:350 http://deb.debian.org/debian bookworm/main amd64 node-cli-boxes all 2.2.1-2 [4696 B]
Get:351 http://deb.debian.org/debian bookworm/main amd64 node-restore-cursor all 4.0.0-2 [4352 B]
Get:352 http://deb.debian.org/debian bookworm/main amd64 node-cli-cursor all 4.0.0-3 [7880 B]
Get:353 http://deb.debian.org/debian bookworm/main amd64 node-colors all 1.4.0-4 [11.9 kB]
Get:354 http://deb.debian.org/debian bookworm/main amd64 node-cli-table all 0.3.11+~cs0.13.4-3 [23.6 kB]
Get:355 http://deb.debian.org/debian bookworm/main amd64 node-cli-truncate all 2.1.0-5 [5628 B]
Get:356 http://deb.debian.org/debian bookworm/main amd64 node-columnify all 1.6.0+~1.5.1-1 [12.4 kB]
Get:357 http://deb.debian.org/debian bookworm/main amd64 node-console-control-strings all 1.1.0-3 [5564 B]
Get:358 http://deb.debian.org/debian bookworm/main amd64 node-growl all 1.10.5-4 [7684 B]
Get:359 http://deb.debian.org/debian bookworm/main amd64 node-lcov-parse all 1.0.0+20170612git80d039574ed9-6 [5116 B]
Get:360 http://deb.debian.org/debian bookworm/main amd64 node-log-driver all 1.2.7+git+20180219+bba1761737-7 [5396 B]
Get:361 http://deb.debian.org/debian bookworm/main amd64 node-data-uri-to-buffer all 4.0.0-3 [5540 B]
Get:362 http://deb.debian.org/debian bookworm/main amd64 node-fetch all 3.3.0+~cs11.4.11-2 [212 kB]
Get:363 http://deb.debian.org/debian bookworm/main amd64 node-coveralls all 3.1.1-2 [13.8 kB]
Get:364 http://deb.debian.org/debian bookworm/main amd64 node-css-selector-tokenizer all 0.8.0+~cs4.8.3-1 [13.0 kB]
Get:365 http://deb.debian.org/debian bookworm/main amd64 node-postcss all 8.4.20+~cs8.0.23-1+deb12u1 [181 kB]
Get:366 http://deb.debian.org/debian bookworm/main amd64 node-icss-utils all 5.1.0+~5.1.0-1 [7564 B]
Get:367 http://deb.debian.org/debian bookworm/main amd64 node-postcss-modules-extract-imports all 3.0.0-2 [6584 B]
Get:368 http://deb.debian.org/debian bookworm/main amd64 node-postcss-modules-values all 4.0.0+~4.0.0-1 [7180 B]
Get:369 http://deb.debian.org/debian bookworm/main amd64 node-postcss-value-parser all 4.2.0-1 [10.4 kB]
Get:370 http://deb.debian.org/debian bookworm/main amd64 node-prr all 1.0.1-3 [4352 B]
Get:371 http://deb.debian.org/debian bookworm/main amd64 node-errno all 1.0.0-3 [7736 B]
Get:372 http://deb.debian.org/debian bookworm/main amd64 node-memory-fs all 0.5.0+~0.3.3-2 [7676 B]
Get:373 http://deb.debian.org/debian bookworm/main amd64 node-tapable all 2.2.1-2 [13.6 kB]
Get:374 http://deb.debian.org/debian bookworm/main amd64 node-enhanced-resolve all 5.10.0-1 [33.6 kB]
Get:375 http://deb.debian.org/debian bookworm/main amd64 node-es-module-lexer all 1.1.0+dfsg-2+deb12u1 [19.7 kB]
Get:376 http://deb.debian.org/debian bookworm/main amd64 node-events all 3.3.0+~3.0.0-3 [5888 B]
Get:377 http://deb.debian.org/debian bookworm/main amd64 node-resolve-cwd all 3.0.0-2 [4212 B]
Get:378 http://deb.debian.org/debian bookworm/main amd64 node-jest-debbundle all 29.3.1~ds1+~cs70.48.25-2 [129 kB]
Get:379 http://deb.debian.org/debian bookworm/main amd64 node-interpret all 2.2.0-3 [7660 B]
Get:380 http://deb.debian.org/debian bookworm/main amd64 node-merge-stream all 2.0.0+~1.1.2-2 [5124 B]
Get:381 http://deb.debian.org/debian bookworm/main amd64 node-jest-worker all 29.3.1~ds1+~cs70.48.25-2 [112 kB]
Get:382 http://deb.debian.org/debian bookworm/main amd64 node-loader-runner all 4.3.0-1 [7644 B]
Get:383 http://deb.debian.org/debian bookworm/main amd64 node-mime all 3.0.0+dfsg+~cs3.97.1-1 [40.4 kB]
Get:384 http://deb.debian.org/debian bookworm/main amd64 node-mime-types all 2.1.35-1 [9456 B]
Get:385 http://deb.debian.org/debian bookworm/main amd64 node-rechoir all 0.8.0+~0.6.1-2 [6628 B]
Get:386 http://deb.debian.org/debian bookworm/main amd64 node-schema-utils all 3.1.1~ds-2 [20.0 kB]
Get:387 http://deb.debian.org/debian bookworm/main amd64 node-randombytes all 2.1.0+~2.0.0-2 [4852 B]
Get:388 http://deb.debian.org/debian bookworm/main amd64 node-serialize-javascript all 6.0.0-2+deb12u1 [12.8 kB]
Get:389 http://deb.debian.org/debian bookworm/main amd64 node-watchpack all 2.4.0+~cs2.8.1-1 [20.2 kB]
Get:390 http://deb.debian.org/debian bookworm/main amd64 node-webassemblyjs all 1.11.4+dfsg+~cs10.11.17-2 [139 kB]
Get:391 http://deb.debian.org/debian bookworm/main amd64 node-source-list-map all 2.0.1+dfsg-2 [9348 B]
Get:392 http://deb.debian.org/debian bookworm/main amd64 node-webpack-sources all 3.2.3+~3.2.0-2 [23.2 kB]
Get:393 http://deb.debian.org/debian bookworm/main amd64 node-terser all 5.16.5-2 [204 kB]
Get:394 http://deb.debian.org/debian bookworm/main amd64 terser all 5.16.5-2 [16.5 kB]
Get:395 http://deb.debian.org/debian bookworm/main amd64 webpack all 5.75.0+dfsg+~cs17.16.14-1+deb12u1 [756 kB]
Get:396 http://deb.debian.org/debian bookworm/main amd64 node-css-loader all 6.7.2+~cs14.0.11-1 [73.0 kB]
Get:397 http://deb.debian.org/debian bookworm/main amd64 node-mimic-response all 3.1.0-8 [5404 B]
Get:398 http://deb.debian.org/debian bookworm/main amd64 node-decompress-response all 6.0.0-2 [4620 B]
Get:399 http://deb.debian.org/debian bookworm/main amd64 node-depd all 2.0.0-2 [11.2 kB]
Get:400 http://deb.debian.org/debian bookworm/main amd64 node-diff all 5.0.0~dfsg+~5.0.1-4 [69.7 kB]
Get:401 http://deb.debian.org/debian bookworm/main amd64 node-end-of-stream all 1.4.4+~1.4.1-1 [5292 B]
Get:402 http://deb.debian.org/debian bookworm/main amd64 node-err-code all 2.0.3+dfsg-3 [4884 B]
Get:403 http://deb.debian.org/debian bookworm/main amd64 node-time-stamp all 2.2.0-2 [6016 B]
Get:404 http://deb.debian.org/debian bookworm/main amd64 node-fancy-log all 1.3.3+~cs1.3.1-2 [7940 B]
Get:405 http://deb.debian.org/debian bookworm/main amd64 node-has-unicode all 2.0.1-5 [3992 B]
Get:406 http://deb.debian.org/debian bookworm/main amd64 node-wide-align all 1.1.3-4 [4244 B]
Get:407 http://deb.debian.org/debian bookworm/main amd64 node-gauge all 4.0.4-1 [19.6 kB]
Get:408 http://deb.debian.org/debian bookworm/main amd64 node-pump all 3.0.0-5 [5136 B]
Get:409 http://deb.debian.org/debian bookworm/main amd64 node-get-stream all 6.0.1-1 [7208 B]
Get:410 http://deb.debian.org/debian bookworm/main amd64 node-lowercase-keys all 2.0.0-2 [3768 B]
Get:411 http://deb.debian.org/debian bookworm/main amd64 node-json-buffer all 3.0.1+~3.0.0-1 [4536 B]
Get:412 http://deb.debian.org/debian bookworm/main amd64 node-p-cancelable all 2.1.1-1 [7272 B]
Get:413 http://deb.debian.org/debian bookworm/main amd64 node-got all 11.8.5+~cs58.13.36-3 [121 kB]
Get:414 http://deb.debian.org/debian bookworm/main amd64 node-https-proxy-agent all 5.0.1+~cs8.0.0-3 [16.1 kB]
Get:415 http://deb.debian.org/debian bookworm/main amd64 node-set-blocking all 2.0.0-2 [4248 B]
Get:416 http://deb.debian.org/debian bookworm/main amd64 node-npmlog all 7.0.1+~4.1.4-1 [11.4 kB]
Get:417 http://deb.debian.org/debian bookworm/main amd64 node-osenv all 0.1.5+~0.1.1-1 [5884 B]
Get:418 http://deb.debian.org/debian bookworm/main amd64 node-tar all 6.1.13+~cs7.0.5-1 [51.1 kB]
Get:419 http://deb.debian.org/debian bookworm/main amd64 node-gyp all 9.3.0-2 [57.9 kB]
Get:420 http://deb.debian.org/debian bookworm/main amd64 node-ieee754 all 1.2.1-3 [5268 B]
Get:421 http://deb.debian.org/debian bookworm/main amd64 node-ini all 3.0.1-2 [6928 B]
Get:422 http://deb.debian.org/debian bookworm/main amd64 node-ip all 2.0.0+~1.1.0-1 [8128 B]
Get:423 http://deb.debian.org/debian bookworm/main amd64 node-ip-regex all 4.3.0+~4.1.1-1 [5188 B]
Get:424 http://deb.debian.org/debian bookworm/main amd64 node-mute-stream all 0.0.8+~0.0.1-3 [6232 B]
Get:425 http://deb.debian.org/debian bookworm/main amd64 node-negotiator all 0.6.3+~0.6.1-1 [10.8 kB]
Get:426 http://deb.debian.org/debian bookworm/main amd64 node-read-package-json all 5.0.2+~2.0.0-1 [12.0 kB]
Get:427 http://deb.debian.org/debian bookworm/main amd64 node-npm-bundled all 2.0.1-2 [6408 B]
Get:428 http://deb.debian.org/debian bookworm/main amd64 node-validate-npm-package-name all 5.0.0+~4.0.0-1 [7444 B]
Get:429 http://deb.debian.org/debian bookworm/main amd64 node-npm-package-arg all 10.0.0+~3.0.0-2 [11.4 kB]
Get:430 http://deb.debian.org/debian bookworm/main amd64 xdg-utils all 1.1.3-4.1 [75.5 kB]
Get:431 http://deb.debian.org/debian bookworm/main amd64 node-opener all 1.5.2+~1.4.0-1 [5940 B]
Get:432 http://deb.debian.org/debian bookworm/main amd64 node-retry all 0.13.1+~0.12.1-1 [11.2 kB]
Get:433 http://deb.debian.org/debian bookworm/main amd64 node-promise-retry all 2.0.1-4 [5016 B]
Get:434 http://deb.debian.org/debian bookworm/main amd64 node-read all 1.0.7-5 [5388 B]
Get:435 http://deb.debian.org/debian bookworm/main amd64 node-promzard all 0.3.0-2 [6788 B]
Get:436 http://deb.debian.org/debian bookworm/main amd64 node-shell-quote all 1.7.4+~1.7.1-1 [14.2 kB]
Get:437 http://deb.debian.org/debian bookworm/main amd64 node-stack-utils all 2.0.6+~2.0.1-1 [9260 B]
Get:438 http://deb.debian.org/debian bookworm/main amd64 node-yaml all 2.1.3-2 [118 kB]
Get:439 http://deb.debian.org/debian bookworm/main amd64 node-tap-parser all 11.0.2+~cs2.1.4-1 [62.7 kB]
Get:440 http://deb.debian.org/debian bookworm/main amd64 node-tap-mocha-reporter all 5.0.3+~2.0.2-2 [38.7 kB]
Get:441 http://deb.debian.org/debian bookworm/main amd64 node-widest-line all 3.1.0-2 [4092 B]
Get:442 http://deb.debian.org/debian bookworm/main amd64 node-ws all 8.11.0+~cs13.7.3-1 [51.1 kB]
Get:443 http://deb.debian.org/debian bookworm/main amd64 node-tap all 16.3.2+ds1+~cs50.8.16-1+deb12u1 [101 kB]
Get:444 http://deb.debian.org/debian bookworm/main amd64 node-text-table all 0.2.0-4 [4736 B]
Get:445 http://deb.debian.org/debian bookworm/main amd64 nodejs-doc all 18.19.0+dfsg-6~deb12u2 [3569 kB]
Get:446 http://deb.debian.org/debian bookworm/main amd64 npm all 9.2.0~ds1-1 [669 kB]
Get:447 http://deb.debian.org/debian bookworm/main amd64 unzip amd64 6.0-28 [166 kB]
Get:448 http://deb.debian.org/debian bookworm/main amd64 x11-xserver-utils amd64 7.7+9+b1 [169 kB]
...
Preparing to unpack .../082-python3-six_1.16.0-4_all.deb ...
...
Preparing to unpack .../084-node-neo-async_2.6.2+~cs3.0.0-2_all.deb ...
...
Preparing to unpack .../089-node-minimist_1.2.7+~cs5.3.2-2_all.deb ...
...
Preparing to unpack .../095-libauthen-sasl-perl_2.1600-3_all.deb ...
Unpacking libauthen-sasl-perl (2.1600-3) ...
Selecting previously unselected package libclone-perl:amd64.
Preparing to unpack .../096-libclone-perl_0.46-1_amd64.deb ...
Unpacking libclone-perl:amd64 (0.46-1) ...
Selecting previously unselected package libdata-dump-perl.
Preparing to unpack .../097-libdata-dump-perl_1.25-1_all.deb ...
Unpacking libdata-dump-perl (1.25-1) ...
Selecting previously unselected package libwayland-server0:amd64.
Preparing to unpack .../098-libwayland-server0_1.21.0-1_amd64.deb ...
Unpacking libwayland-server0:amd64 (1.21.0-1) ...
Selecting previously unselected package libgbm1:amd64.
Preparing to unpack .../099-libgbm1_22.3.6-1+deb12u1_amd64.deb ...
...
Preparing to unpack .../101-libegl-mesa0_22.3.6-1+deb12u1_amd64.deb ...
Unpacking libegl-mesa0:amd64 (22.3.6-1+deb12u1) ...
Selecting previously unselected package libencode-locale-perl.
Preparing to unpack .../102-libencode-locale-perl_1.05-3_all.deb ...
Unpacking libencode-locale-perl (1.05-3) ...
Selecting previously unselected package libipc-system-simple-perl.
Preparing to unpack .../103-libipc-system-simple-perl_1.30-2_all.deb ...
Unpacking libipc-system-simple-perl (1.30-2) ...
Selecting previously unselected package libfile-basedir-perl.
Preparing to unpack .../104-libfile-basedir-perl_0.09-2_all.deb ...
Unpacking libfile-basedir-perl (0.09-2) ...
Selecting previously unselected package libregexp-ipv6-perl.
Preparing to unpack .../105-libregexp-ipv6-perl_0.03-3_all.deb ...
Unpacking libregexp-ipv6-perl (0.03-3) ...
Selecting previously unselected package liburi-perl.
Preparing to unpack .../106-liburi-perl_5.17-1_all.deb ...
Unpacking liburi-perl (5.17-1) ...
Selecting previously unselected package libfile-desktopentry-perl.
Preparing to unpack .../107-libfile-desktopentry-perl_0.22-3_all.deb ...
Unpacking libfile-desktopentry-perl (0.22-3) ...
Selecting previously unselected package libtimedate-perl.
Preparing to unpack .../108-libtimedate-perl_2.3300-2_all.deb ...
Unpacking libtimedate-perl (2.3300-2) ...
Selecting previously unselected package libhttp-date-perl.
Preparing to unpack .../109-libhttp-date-perl_6.05-2_all.deb ...
Unpacking libhttp-date-perl (6.05-2) ...
Selecting previously unselected package libfile-listing-perl.
Preparing to unpack .../110-libfile-listing-perl_6.15-1_all.deb ...
Unpacking libfile-listing-perl (6.15-1) ...
Selecting previously unselected package libfile-mimeinfo-perl.
Preparing to unpack .../111-libfile-mimeinfo-perl_0.33-1_all.deb ...
Unpacking libfile-mimeinfo-perl (0.33-1) ...
Selecting previously unselected package libfont-afm-perl.
Preparing to unpack .../112-libfont-afm-perl_1.20-4_all.deb ...
Unpacking libfont-afm-perl (1.20-4) ...
Selecting previously unselected package libgles2:amd64.
Preparing to unpack .../113-libgles2_1.6.0-1_amd64.deb ...
Unpacking libgles2:amd64 (1.6.0-1) ...
Selecting previously unselected package libhtml-tagset-perl.
Preparing to unpack .../114-libhtml-tagset-perl_3.20-6_all.deb ...
...
Preparing to unpack .../198-node-babel-plugin-add-module-exports_1.0.4+dfsg1~cs5.8.0-4_all.deb ...
...
Preparing to unpack .../199-node-regenerator-runtime_0.15.1+~0.10.8-1_all.deb ...
Unpacking node-regenerator-runtime (0.15.1+~0.10.8-1) ...
Selecting previously unselected package node-babel7-runtime.
Preparing to unpack .../200-node-babel7-runtime_7.20.15+ds1+~cs214.269.168-3+deb12u2_all.deb ...
...
Preparing to unpack .../201-node-babel-helper-define-polyfill-provider_0.3.3~0~20220913+ds1-1_all.deb ...
...
Preparing to unpack .../202-node-babel-plugin-polyfill-corejs2_0.3.3~0~20220913+ds1-1_all.deb ...
...
Preparing to unpack .../209-node-babel-plugin-polyfill-regenerator_0.4.1~0~20220913+ds1-1_all.deb ...
...
Preparing to unpack .../230-node-unicode-canonical-property-names-ecmascript_2.0.0-2_all.deb ...
...
Preparing to unpack .../231-node-unicode-property-aliases-ecmascript_2.1.0+ds-1_all.deb ...
...
Preparing to unpack .../232-node-unicode-match-property-ecmascript_2.0.0-2_all.deb ...
...
Preparing to unpack .../233-node-unicode-match-property-value-ecmascript_2.1.0+ds-1_all.deb ...
...
Preparing to unpack .../256-node-write-file-atomic_4.0.2+~4.0.0-1_all.deb ...
...
Preparing to unpack .../260-node-clone_2.1.2-4_all.deb ...
...
Preparing to unpack .../265-node-cliui_7.0.4+repack+~cs3.1.0-4_all.deb ...
...
Preparing to unpack .../272-node-istanbul_0.4.5+repack10+~cs97.25.57-3_all.deb ...
...
Preparing to unpack .../275-node-tape_5.6.1+~cs8.20.19-1_all.deb ...
Unpacking node-tape (5.6.1+~cs8.20.19-1) ...
Selecting previously unselected package node-deep-equal.
Preparing to unpack .../276-node-deep-equal_2.1.0+~cs31.12.80-1_all.deb ...
...
Preparing to unpack .../278-libnet-http-perl_6.22-1_all.deb ...
Unpacking libnet-http-perl (6.22-1) ...
Selecting previously unselected package libtry-tiny-perl.
Preparing to unpack .../279-libtry-tiny-perl_0.31-2_all.deb ...
Unpacking libtry-tiny-perl (0.31-2) ...
Selecting previously unselected package libwww-robotrules-perl.
Preparing to unpack .../280-libwww-robotrules-perl_6.02-1_all.deb ...
Unpacking libwww-robotrules-perl (6.02-1) ...
Selecting previously unselected package libwww-perl.
Preparing to unpack .../281-libwww-perl_6.68-1_all.deb ...
Unpacking libwww-perl (6.68-1) ...
Selecting previously unselected package liblwp-protocol-https-perl.
Preparing to unpack .../282-liblwp-protocol-https-perl_6.10-1_all.deb ...
Unpacking liblwp-protocol-https-perl (6.10-1) ...
Selecting previously unselected package libnet-smtp-ssl-perl.
Preparing to unpack .../283-libnet-smtp-ssl-perl_1.04-2_all.deb ...
Unpacking libnet-smtp-ssl-perl (1.04-2) ...
Selecting previously unselected package libmailtools-perl.
Preparing to unpack .../284-libmailtools-perl_2.21-2_all.deb ...
Unpacking libmailtools-perl (2.21-2) ...
Selecting previously unselected package libxml-parser-perl.
Preparing to unpack .../285-libxml-parser-perl_2.46-4_amd64.deb ...
Unpacking libxml-parser-perl (2.46-4) ...
Selecting previously unselected package libxml-twig-perl.
Preparing to unpack .../286-libxml-twig-perl_1%3a3.52-2_all.deb ...
Unpacking libxml-twig-perl (1:3.52-2) ...
Selecting previously unselected package libnet-dbus-perl.
Preparing to unpack .../287-libnet-dbus-perl_1.2.0-2_amd64.deb ...
Unpacking libnet-dbus-perl (1.2.0-2) ...
Selecting previously unselected package libssl-dev:amd64.
Preparing to unpack .../288-libssl-dev_3.0.17-1~deb12u2_amd64.deb ...
